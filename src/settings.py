...
##################################
PROJECT_NAME: str = "DUTS"
PROJECT_NAME_FULL: str = "DUTS"
...
APPLICATIONS: List[Union[Industry, Domain, Research]] = [Domain.General(benchmark=True)]
...
PREVIEW_IMAGE_ID: int = 7464901
# This should be filled AFTER uploading images to instance, just ID of any image.

GITHUB_URL: str = "https://github.com/dataset-ninja/duts"
...
PAPER: Optional[Union[str, List[str], Dict[str, str]]] = ["http://saliencydetection.net/duts/download/camera_ready.pdf"]
BLOGPOST: Optional[Union[str, List[str], Dict[str, str]]] = None
REPOSITORY: Optional[Union[str, List[str], Dict[str, str]]] = {"GitHub":"https://github.com/scott89/WSS"}

CITATION_URL: Optional[str] = "http://saliencydetection.net/duts/#org1278077"
